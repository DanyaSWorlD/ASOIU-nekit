...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Models.ModelTypes.Type" HeaderText="Тип" SortExpression="Models" />
            <asp:BoundField DataField="Models.Model" HeaderText="Наименование" SortExpression="Models" />
        </Columns>
